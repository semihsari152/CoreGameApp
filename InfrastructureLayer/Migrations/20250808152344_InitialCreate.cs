        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEarlyAccess = table.Column<bool>(type: "bit", nullable: false),
                    GameSeriesId = table.Column<int>(type: "int", nullable: true),
                    IGDBId = table.Column<int>(type: "int", nullable: true),
                    IGDBSlug = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IGDBUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IGDBLastUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IGDBLastSync = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CoverImageId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportableEntityId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainAvgSeconds = table.Column<int>(type: "int", nullable: true),
                    MainPolledCount = table.Column<int>(type: "int", nullable: true),
                    ExtraAvgSeconds = table.Column<int>(type: "int", nullable: true),
                    ExtraPolledCount = table.Column<int>(type: "int", nullable: true),
                    CompletionistAvgSeconds = table.Column<int>(type: "int", nullable: true),
                    CompletionistPolledCount = table.Column<int>(type: "int", nullable: true),
                    AllAvgSeconds = table.Column<int>(type: "int", nullable: true),
                    AllPolledCount = table.Column<int>(type: "int", nullable: true),
                    HltbGameName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    HltbGameId = table.Column<int>(type: "int", nullable: true),
                    LastUpdated = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameBeatTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameBeatTimes_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameGameModes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameGameModes_GameModes_GameModeId",
                        column: x => x.GameModeId,
                        principalTable: "GameModes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameGameModes_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "GameIgdbRatings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GameId = table.Column<int>(type: "int", nullable: false),
                    UserRating = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    UserRatingCount = table.Column<int>(type: "int", nullable: true),
                    CriticRating = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    CriticRatingCount = table.Column<int>(type: "int", nullable: true),
                    LastUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IgdbLastSync = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameIgdbRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameIgdbRatings_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameKeywords", x => new { x.GameId, x.KeywordId });
                    table.ForeignKey(
                        name: "FK_GameKeywords_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameKeywords_Keywords_KeywordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameWebsites_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGameStatuses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumTopicTags", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ForumTopicTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LikableType = table.Column<int>(type: "int", nullable: false),
                    TargetEntityId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_CommentableType_TargetEntityId",
                table: "Comments",
                columns: new[] { "CommentableType", "TargetEntityId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumTopicTags_ForumTopicId_TagId",
                table: "ForumTopicTags",
                columns: new[] { "ForumTopicId", "TagId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ForumTopicTags_TagId",
                table: "ForumTopicTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_GameBeatTimes_GameId",
                table: "GameBeatTimes",
                column: "GameId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GameBeatTimes_HltbGameId",
                table: "GameBeatTimes",
                column: "HltbGameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameGameModes_GameId_GameModeId",
                table: "GameGameModes",
                columns: new[] { "GameId", "GameModeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GameGameModes_GameModeId",
                table: "GameGameModes",
                column: "GameModeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameIgdbRatings_GameId",
                table: "GameIgdbRatings",
                column: "GameId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GameKeywords_KeywordId",
                table: "GameKeywords",
                column: "KeywordId");

            migrationBuilder.CreateIndex(
                name: "IX_GameMedia_GameId_MediaType",
                table: "GameMedia",
                columns: new[] { "GameId", "MediaType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameRatings_GameId_UserId",
                table: "GameRatings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameThemes_GameId_ThemeId",
                table: "GameThemes",
                columns: new[] { "GameId", "ThemeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameWebsites_GameId_WebsiteType",
                table: "GameWebsites",
                columns: new[] { "GameId", "WebsiteType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_UserId_LikableType_TargetEntityId",
                table: "Likes",
                columns: new[] { "UserId", "LikableType", "TargetEntityId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerPerspectives_Name",
                table: "PlayerPerspectives",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_ReportableType_ReportableEntityId",
                table: "Reports",
                columns: new[] { "ReportableType", "ReportableEntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_Reports_ReporterId_ReportableType_ReportableEntityId",
                table: "Reports",
                columns: new[] { "ReporterId", "ReportableType", "ReportableEntityId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGameStatuses_UserId_GameId",
                table: "UserGameStatuses",
